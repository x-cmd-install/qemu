...
合计: **2,490,301** 行代码（覆盖前 5 种语言、共 **8061** 个文件）。
...
- **Star**: 13,714 · **Fork**: 7,174 · **开放 issue**: 0 · **贡献者**: 1,920

## 累计统计

- **发布数**: 0 · **已合并 PR**: 0 · **开放 PR**: 0 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 133126
...
在 [repology.org](https://repology.org/project/qemu) 上共有 **2364** 个发行版报告此项目。**670** 个 ✅ 已是最新上游版本，**1572** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T06:03:11Z._
